fetch(`http://localhost:5500/users/requests`, {
        method: 'GET',
        mode: 'cors',
        headers: {
    ...
    .then(data => {
        ...
        data.map((user) => {
            ...
            <td><button class="btn-submit" id="btn-submit-denied" onclick="deleteUser(${user.numSoliName},'${user.userSoliName}')"><svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24"><path fill="currentColor" d="M20 6.91L17.09 4L12 9.09L6.91 4L4 6.91L9.09 12L4 17.09L6.91 20L12 14.91L17.09 20L20 17.09L14.91 12z"/></svg></button> <button type="submit" class="btn-submit" id="btn-submit-approve" onclick="userVerified('${user.userSoliName}')"><svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24"><path fill="currentColor" d="m9 20.42l-6.21-6.21l2.83-2.83L9 14.77l9.88-9.89l2.83 2.83z"/></svg></button></td>
            `
...
function deleteUser(id, name) {
    ...
    let getTableRow = document.getElementById(`tr-${id}`)
    getTableRow.remove();
